...
<div id="box">
	<div class="title">Login to STRESSWEB Panel</div>
	<div class="formbox">
		<form action="" method="post">
			<table cellpadding="0" cellspacing="2" border="0">
			<tr>
				<td width="150" height="25" align="left"><label>Account: </label></td>
				<td width="150" align="right"><input type="text" name="acp_login" class="inp"></td>
			</tr>
			<tr>
				<td height="25" align="left"><label>Password: </label></td>
				<td align="right"><input type="password" name="acp_pass" class="inp"></td>
			</tr>
			[code]
			<tr>
				<td height="40" align="left"><label>Code:</label><img src="{url}/module/antibot.php?rndval=2012" align="absmiddle" /></td>
