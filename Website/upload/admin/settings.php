...
<tr>
    <td bgcolor="#EEEFEF" height="55" style="padding-left:10px; color: #c00;" align="left">
		<a href="javascript:ChangeOption('divGeneral');"><img src='{$THEME}/general.png' title='Общие настройки'></a> &nbsp; &nbsp;  
		<a href="javascript:ChangeOption('divCode');"><img src='{$THEME}/code.png' title='Безопасность'></a> &nbsp; &nbsp;  
		<a href="javascript:ChangeOption('divSMTP');"><img src='{$THEME}/mail.png' title='Настройка E-Mail'></a> &nbsp; &nbsp;
		<a href="javascript:ChangeOption('divForum');"><img src='{$THEME}/forum.png' title='Темы с Форума'></a> &nbsp; &nbsp; 
		<a href="javascript:ChangeOption('divCache');"><img src='{$THEME}/cache.png' title='Настройки кеширования'></a> &nbsp; &nbsp; 
		<a href="javascript:ChangeOption('divLogin');"><img src='{$THEME}/login.png' title='Логин Сервер'></a> &nbsp; &nbsp;
		<a href="javascript:ChangeOption('divGame');"><img src='{$THEME}/game.png' title='Игровой Сервер'></a> &nbsp; &nbsp;
		<a href="javascript:ChangeOption('divL2Top');"><img src='{$THEME}/l2top.png' title='L2Top'></a> &nbsp; &nbsp; 
		<a href="javascript:ChangeOption('divRobokassa');"><img src='{$THEME}/rk.png' title='Robokassa'></a>
	</td>
</tr>
</table><br />
HTML;
