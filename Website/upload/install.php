...
<tr>
	...
	<td align="right" valign="top">'.$button2.'<br><br> <a href="http://stressweb.ru"><span style="font-size: 9px; color: #fff;">© 2008-2012 STRESS WEB</span></a></td>
</tr>
</table>
	</td>
</tr>
...
if ($step == 3)
{
    $important_files = array('./online.txt', './log_auth.php', './cache/', './config/', './config/config.l2cfg.php', './config/config.db.php', );
