...
<tr>
	<td colspan="2" align="center" class="title_main"><p>Регистрация аккаунта</p></td>
</tr>
[servers]
<tr>
...
[/referal]
<tr>
  	<td colspan="2" style="text-align: center;"><input type="submit" name="register"  value="Регистрация" class="btn btn-default" /></td>
</tr>
<tr>
	<td colspan="2" align="left" class="title_main"><p>Пожалуйста, вводите свой действующий E-MAIL.Без него Вы не сможете :
<ul>
<li>Активировать аккаунт.</li>
<li>Восстановить пароль.</li>
<li>Восстановить префикс.</li>
<li>Восстановить ключ от персонажа.</li>
<li>Убрать привязку по HWID.</li>
</ul>
ВАЖНО! Любыe проблемы с аккаунтом, без действующего E-MAIL, не будут рассматриваться администрацией.</p></td>
</tr>
</table>
</form>
</div>
